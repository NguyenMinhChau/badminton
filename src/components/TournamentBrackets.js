							...
							<div className="flex flex-row gap-1 items-start">
								<div className="flex-1 flex flex-col items-start">
									<input
										...
										className={`bg-opacity-30 outline-none border-none py-2 text-[14px] mx-1 ${colorPosition0} ${backgroundPosition0} font-bold p-[2px] rounded-tl-md rounded-br-md text-center`}
									/>
