						...
						<div>
							{!_noDescription && !desc_bypass && (
								<input
									...
									className={`w-full px-2 py-1 bg-black bg-opacity-5 text-[#ea580c] outline-none font-bold border-none text-[13px] text-center`}
							...
							<div
								className="flex flex-row gap-1 m-2 mt-[2px]"
								style={{
